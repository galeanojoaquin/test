...
<head>
	...
	<div  class="row">
		...
		<form action="test_meli.php"  method="post">       
...
<?php
 ...
 y el siguiente es el seller_ID. 
 # Desarrollador: Galeano Joaquin <igaleanojoaquin@gmail.com> */
  ...
  if(isset($site_ID)&&isset($seller_ID)){
    ...
    $datafilter = $data['results'];
      foreach($datafilter as $dat){
        ...
        $ar=fopen("output.log","a") or die("Hubo problemas en la creacion del archivo");
